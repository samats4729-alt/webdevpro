...
export default function SignupPage() {
    ...
    const handleGoogleLogin = async () => {
        const supabase = createClient();
        // Use production URL or window.location.origin for local dev
            ...
            <div className="w-full max-w-[400px] relative z-10">
                ...
                <div className="relative group">
                    ...
                    <div className="relative bg-[#0a0a0a]/90 backdrop-blur-xl border border-white/10 rounded-3xl p-6 shadow-2xl">
                        ...
                        <button onClick={handleGoogleLogin} type="button" className="w-full py-2.5 rounded-xl border border-white/10 bg-white/5 hover:bg-white/10 hover:border-white/20 transition-all text-white font-medium flex items-center justify-center gap-3 group/google">
